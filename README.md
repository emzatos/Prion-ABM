...
Since the code is being run through the REPL, it is very common for the environment to 'hold on' to old variables. So, whenever a change is made, its best to run the Restart REPL command before running again
